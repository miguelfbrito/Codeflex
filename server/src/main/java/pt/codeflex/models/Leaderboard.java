...
@SqlResultSetMappings({
		@SqlResultSetMapping(name = "HighestScoreMapping", classes = @ConstructorResult(targetClass = Leaderboard.class, columns = {
...
public class Leaderboard {
	...
	public Leaderboard(long id, double score, Users users, Problem problem) {
		this.id = id;
		this.score = score;
		this.users = users;
	...
	public Leaderboard(double score, Users users, Problem problem, String language) {
		this.score = score;
		this.users = users;
		this.problem = problem;
