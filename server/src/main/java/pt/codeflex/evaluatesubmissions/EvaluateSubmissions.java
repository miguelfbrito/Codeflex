...
public class EvaluateSubmissions implements Runnable {
    ...
    @Autowired
    public EvaluateSubmissions(DatabaseController db, ScoringRepository scoringRepository, SubmissionsRepository submissionsRepository,
                               ResultRepository resultRepository, LeaderboardRepository leaderboardRepository) {
        this.db = db;
    ...
    public boolean compiledSuccessfully(Submissions submission) {
        ...
        try {
            ...
            if (!output.equals("")) {
                ...
                Scoring sc = new Scoring(submission, new TestCase(), 0, 0);
